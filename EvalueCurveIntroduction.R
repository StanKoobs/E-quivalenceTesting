...
cfg <- list(
  ...
  plot_php      = FALSE,     # TRUE: plot 1/e_mu ; FALSE: plot e_mu
  swap_axes     = FALSE,     # TRUE: x=value, y=mu ; FALSE: x=mu, y=value
  use_log_scale = FALSE,    # log10 on value axis
  value_limits  = c(0, 50),     # limits on value axis (x if swap_axes else y)
